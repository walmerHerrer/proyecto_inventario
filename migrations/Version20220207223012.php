 ...
 */
final class Version20220207223012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE detalle_orden_compra CHANGE cant_recibida cant_recibida NUMERIC(10, 2) NOT NULL');
        $this->addSql('ALTER TABLE orden_pedido ADD fecha_despacho DATETIME DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE despacho (id INT AUTO_INCREMENT NOT NULL, almacen_id INT DEFAULT NULL, trabajador_id INT DEFAULT NULL, propietario_id INT DEFAULT NULL, config_id INT DEFAULT NULL, fecha_salida DATETIME NOT NULL, items_desapachados NUMERIC(10, 2) DEFAULT NULL, cantidad_despacho NUMERIC(10, 2) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, activo TINYINT(1) NOT NULL, uuid BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_254BF5B3EC3656E (trabajador_id), INDEX IDX_254BF5B353C8D32C (propietario_id), UNIQUE INDEX UNIQ_254BF5B3D17F50A6 (uuid), INDEX IDX_254BF5B324DB0683 (config_id), INDEX IDX_254BF5B39C9C9E68 (almacen_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE despacho_producto (despacho_id INT NOT NULL, producto_id INT NOT NULL, INDEX IDX_5E7410057645698E (producto_id), INDEX IDX_5E741005299C08BC (despacho_id), PRIMARY KEY(despacho_id, producto_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE detalle_orden_compra CHANGE cant_recibida cant_recibida NUMERIC(10, 0) NOT NULL');
        $this->addSql('ALTER TABLE orden_pedido DROP fecha_despacho');
    }
}

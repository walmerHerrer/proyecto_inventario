...
final class OrdenCompraCache
{
    ...
    public function ordenCompras(callable $callback)
    {
        $cache_key = $this->prefix().$this->ordenComprasKey();
        $cache_tags = $this->tags();
    ...
    public function ordenComprasKey(): string
    {
        return 'ordenCompras_';
    }

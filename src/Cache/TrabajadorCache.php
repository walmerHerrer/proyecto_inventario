...
final class TrabajadorCache
{
    ...
    public function trabajadors(callable $callback)
    {
        $cache_key = $this->prefix().$this->trabajadorsKey();
        $cache_tags = $this->tags();
    ...
    public function trabajadorsKey(): string
    {
        return 'trabajadors_';
    }
